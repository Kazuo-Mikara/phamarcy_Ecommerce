...
if (isset($_POST['edit_discount'])) {
   ...
   status='$discount_status'
    ...
    if ($res1 == TRUE) {
        ...
        header('location:' . SITEURL . 'admin/manage_discounts.php');
    }
}
        ...
        <div class="main-panel">
            ...
            <div class="container">
                <div class="page-inner">
                    <h3 class="fw-bold mb-3">Edit Discounts</h3>
                    ...
                    <form class="max-w-sm mx-auto mt-8" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group form-group-default">
                                    ...
                                    <input id="addName" name="discount_name" type="text" class="form-control"
                                        placeholder="Discount Name" value="<?php echo $discount_name ?>" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 ">
                                <div class="form-group form-group-default">
                                    ...
                                    <input id="addPosition" type="text" class="form-control" name="discount_percent"
                                        placeholder="discount_percent" value="<?php echo $discount_percent ?>" />
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="mb-5 form-group form-group-default">
                                    <label for="countries"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select
                                        an option</label>
                                    <select id="discount_status" name="discount_status" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                                    block w-full p-2.5
                                    ">
                                        <option selected><?php $discount_status = isset($discount_status) ? $discount_status : 'Select Order Status';
                                        echo $discount_status; ?></option>
                        ...
                        <input type="submit" name="edit_discount" id="displayNoti" value="Edit Discount"
                            class="btn btn-success">
                        <a class="btn btn-danger" href="./manage_discounts.php">Cancel</a>
                    </form>
