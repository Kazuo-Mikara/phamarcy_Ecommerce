...
$get_gmail = $row['gmail'];
$get_delivery_status = $row['delivery_status'];
...
if (isset($_POST['edit_user'])) {
   ...
   delivery_status='$delivery_status'
    ...
    if ($res1 == TRUE) {
        ...
        header('location:' . SITEURL . 'admin/manage_users.php');
    }
}
            ...
            <div class="container">
                <div class="page-inner">
                    ...
                    <form class="max-w-sm mx-auto mt-8" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12 ">
                                <div class="form-group form-group-default">
                                    ...
                                    <input id="addPosition" type="text" class="form-control" name="gmail"
                                        placeholder="Gmail" value="<?php echo $get_gmail ?>" />
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="mb-5 form-group form-group-default">
                                    <label for="countries"
                                        ...
                                        an option</label>
                                    <select id="delivery_status" name="delivery_status" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                                    block w-full p-2.5
                                    ">
                                        <option selected><?php $delivery_status = isset($get_delivery_status) ? $get_delivery_status : 'Select Delivery Status';
                                        echo $delivery_status; ?></option>
                        ...
                        <input type="submit" name="edit_user" id="displayNoti" value="Edit User"
                            class="btn btn-success">
                        <a class="btn btn-danger" href="./manage_users.php">Cancel</a>
                    </form>
