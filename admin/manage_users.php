                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group form-group-default">
                                                                    ...
                                                                    <select id="delivery_status" name="delivery_status"
                                                                        ...
                                                                        <option selected><?php $category = isset($delivery_status) ? $delivery_status : 'Select Order Status';
                                            ...
                                            <tbody>
                                                ...
                                                while ($rows = mysqli_fetch_assoc($result2)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="<?php if ($delivery_status == 'Pending') {
                                                            echo 'btn-primary';
                                                        ...
                                                        <td>
                                                            <div class="form-button-action">
                                                                <a href="./edit_users.php?id=<?php echo $id; ?>"
                                                                    class="btn btn-link btn-primary ">
                                                                    <i class="fa fa-edit"></i>
                                                                </a>
                                                                <a href="./manage_users.php?delete=true & id=<?php echo $id; ?>"
