                        ...
                        <form class="max-w-sm mx-auto mt-8" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-5">
                                <label for="product_name"
                                    ...
                                    Name</label>
                                <input type="text" value="<?php echo $product_name; ?>" id="product_name"
                                    name="product_name"
                            ...
                            <div class="mb-5">
                                <label for="countries"
                                    ...
                                    an option</label>
                                <select id="countries" name="category" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                                    focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700
                                    dark:border-gray-600 dark:placeholder-gray-400 dark:text-white
                                    dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    <option selected><?php $category = isset($category) ? $category : 'Select Category';
                                    echo $category; ?></option>
                                    <option value="Analgesics & Anti-Inflammatory">Analgesics & Anti-Inflammatory
                                    </option>
                            ...
                            <div class="mb-5">
                                ...
                                <textarea rows="10" cols="5" name="indication" id="indication"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                                    required> <?php echo $indication ?></textarea>
                            </div>
                            <div class="mb-5">
                                <label for="packaging"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Packaging</label>
                                <input type="text" name="packaging" id="packaging" value="<?php echo $packaging ?>"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                                    required />
                            </div>
                            <div class="mb-5">
                            ...
                            <div class="mb-5">
                                ...
                                <input type="text" name="price" id="country" value="<?php echo $price ?>"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                                    required />
                            </div>
                            <div class="mb-5">
                                ...
                                <input type="text" name="quantity" id="country" value="<?php echo $quantity ?>"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                                    required />
                            </div>
                            <div class="mb-5">
                                <label for="Image"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Existing
                                    Image</label>
                                <img src="../images/category<?php echo $existing_image ?>" width="100px">
                                <label for="Image"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Add New
                                    Image</label>
